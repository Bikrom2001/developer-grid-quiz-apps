...
const Quiz = ({ optioncs }) => {
    ...
    return (
        <div className='flex mb-8 mx-auto flex-col max-w-2xl p-6 space-y-6 overflow-hidden rounded-lg shadow-md bg-slate-800 text-black'>
            ...
            <div>
                <div onChange={()=> worngAndCorrect(options[0])} className='flex items-center mb-3 pl-4 rounded border border-gray-200 dark:border-gray-700'>
                    <input type="radio" name="bordered-radio" id={id} className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-0 dark:bg-gray-700 dark:border-gray-600' />
                    <label htmlFor={id} className='py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300'>{options[0]}</label>
                </div>
                <div onChange={()=> worngAndCorrect(options[1])} className='flex items-center mb-3 pl-4 rounded border border-gray-200 dark:border-gray-700'>
                    <input type="radio" name="bordered-radio" id={id} className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-0 dark:bg-gray-700 dark:border-gray-600' />
                    <label htmlFor={id} className='py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300'>{options[1]}</label>
                </div>
                <div onChange={()=> worngAndCorrect(options[2])} className='flex items-center mb-3 pl-4 rounded border border-gray-200 dark:border-gray-700'>
                    <input type="radio" name="bordered-radio" id={id} className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-0 dark:bg-gray-700 dark:border-gray-600' />
                    <label htmlFor={id} className='py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300'>{options[2] ? options[2] : 'unfined'}</label>
                </div>
                <div onChange={()=> worngAndCorrect(options[3])} className='flex items-center pl-4 rounded border border-gray-200 dark:border-gray-700'>
                    <input type="radio" name="bordered-radio"  id={id} className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-0 dark:bg-gray-700 dark:border-gray-600' />
